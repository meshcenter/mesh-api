...
exports.up = pgm => {
	...
	abandon_date: { type: 'timestamp with time zone' },
	device_type_id: { type: 'integer', references: 'device_types(id)', notNull },
	node_id: { type: 'integer', references: 'nodes(id)', notNull },
    });

    pgm.createType('link_status', [
	'planned',
	'active',
	'dead',
    ]);
    ...
    pgm.createType('appointment_type', [
	'install',
	'support',
	'survey',
    ]);
